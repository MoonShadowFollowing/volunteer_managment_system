...
|---|---|---|
| `00000000` | 超管 | FR-08 |
| `12345678` | 管理员 | FR-01 审核 / FR-09 审核 / FR-10 发公告 |
| `202400010101` | 志愿者 + 组织者（双身份）| FR-01 / FR-02 / FR-03 / FR-04 |
| `202400020101` | 普通志愿者 | FR-02 / FR-05 / FR-09 / FR-10 |
| `202400040101` | 批量种子志愿者 | 用于展示"累计工时统计"和对外 API |
